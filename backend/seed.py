...
from db import SessionLocal, ensure_schema, create_all_kadai
from models import (Shop, Customer, Product, Order, Message, ReadyMessage,
                    Broadcast, BroadcastRecipient, User, Subscription)
from auth import hash_password

# Sign in with these to explore the seeded shop.
DEMO_EMAIL = "demo@kadai.shop"
...
def seed():
    ...
    with SessionLocal() as db:
        ...
        demo_user = User(email=DEMO_EMAIL, name="Murugan", provider="email",
        ...
        db.add(Subscription(shop_id=sid, plan_id="kadai_monthly", status="active",
                            price_inr=1500,
